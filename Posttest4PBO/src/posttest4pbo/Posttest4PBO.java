                        ...
                        case 1:
                            ...
                            if (pilihan12 == 1) {
                                    ...
                                    if(dataBaru.isEmpty()) {
                                        ...
                                        System.out.println("\n");
                                            for(int i = 0; i < dataBaru.size(); i++) {
                                                dataBaru.get(i).displayInfo(true);
                                            }
                                            break;
                                    } 
                            } else if (pilihan12 == 2) {
                                if(dataBaru.isEmpty()) {
                                    ...
                                    System.out.println("\n");
                                        for(int i = 0; i < dataBaru.size(); i++) {
                                            dataBaru.get(i).displayInfo(false);
                                            break;
                                        }
                                        break;
                                }
                        ...
                        case 2:
                            ...
                            if (pilihan13 == 1) {
                                System.out.println("\n");
                                     if(dataLama.isEmpty()) {
                                        ...
                                        for(int j = 0; j < dataLama.size(); j++) {
                                            dataLama.get(j).displayInfo(true);
                                        }
                                        break;
                                    }
                            } else if (pilihan13 == 2) {
                                if(dataLama.isEmpty()) {
                                    ...
                                    System.out.println("\n");
                                        for(int j = 0; j < dataLama.size(); j++) {
                                            dataLama.get(j).displayInfo(false);
                                        }
                                        break;
                                }
                            } else if (pilihan13 == 3) {
