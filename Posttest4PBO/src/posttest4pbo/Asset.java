...
public class Asset {
    ...
    public void displayInfo() {
        System.out.println("\n==========================================================================================");
        System.out.printf("| %-9s | %-20s | %-20s | %-10s | %-15s |","ID BARANG", "NAMA BARANG", "LOKASI", "KUANTITAS", "HARGA");
        System.out.println("\n");
        System.out.printf("| %-9s | %-20s | %-20s | %-10s | %-15s |", this.IdAsset, this.NamaAsset, this.Lokasi, this.Kuantitas, this.Harga);
    }
