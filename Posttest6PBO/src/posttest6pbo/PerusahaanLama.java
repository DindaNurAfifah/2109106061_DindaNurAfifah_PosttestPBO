 ...
 * @author USER
 */
final class PerusahaanLama extends Asset {
    private final int TanggalLama;
    private String Lokasi;

    public PerusahaanLama(String NamaAsset, String Lokasi, int IdAsset, int Kuantitas, int Harga, int Tanggal) {
