                ...
                case 1:
                    ...
                    switch(pilihan1) {
                        case 1:
                            ...
                            System.out.println("=                                              READ DATA ASSET                                         =");
                            System.out.println("========================================================================================================");
                            System.out.println("=                                         [1] Tampil Data Lengkap                                      =");
                            System.out.println("=                                         [2] Tampil Data Tanpa Tanggal                                =");
                            System.out.println("=                                         [3] Exit                                                     =");
                            System.out.println("========================================================================================================");
                            System.out.println("Pilih Menu: [1/2]");
                            int pilihan12 = Integer.parseInt(br.readLine());
                            if (pilihan12 == 1) {
                                System.out.println("\n");
                                    if(dataBaru.isEmpty()) {
                                        System.out.println("========================================================================================================");
                        ...
                        case 2:
                            ...
                            System.out.println("========================================================================================================");
                            System.out.println("Pilih Menu: [1/2/3]");
                            int pilihan13 = Integer.parseInt(br.readLine());
                            if (pilihan13 == 1) {
                                System.out.println("\n");
                                     if(dataLama.isEmpty()) {
                                        System.out.println("========================================================================================================");
                                    ...
                                    break;
                                        ...
                                        for(PerusahaanBaru bru : dataBaru) {
                                            if(bru.getNamaAsset().equals(findbru)){
                                                ...
                                                System.out.print("Tanggal       : ");bru.setTanggal(Integer.parseInt(br.readLine()));
                                                System.out.println("========================================================================================================");
                                    ...
                                    break;
                                        ...
                                        for(PerusahaanLama lma : dataLama) {
                                            if(lma.getNamaAsset().equals(findlma)){
                                                ...
                                                System.out.print("Tanggal       : ");lma.setTanggal(Integer.parseInt(br.readLine()));
                                                System.out.println("========================================================================================================");
                                                System.out.println("=                                              UPDATE DATA SUCSSES                                     =");
                                                System.out.println("========================================================================================================");
                                            } else {
